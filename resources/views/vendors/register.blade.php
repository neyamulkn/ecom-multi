                   ...
                   <div class="card-body">
                        ...
                        <form data-parsley-validate action="{{route('vendorRegister')}}" method="post" >
                            ...
                            <div class="form-group">
                              ...
                              <input type="text" required name="name" value="{{old('name')}}" placeholder="Enter Name" data-parsley-required-message = "Name is required" id="name" class="form-control">
                              @if ($errors->has('name'))
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    ...
                                    <select name="state" required onchange="get_city(this.value)"  id="state" data-parsley-required-message = "Rejion name is required" class="form-control">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select name="city" required data-parsley-required-message = "City name is required" onchange="get_area(this.value)"  id="city" class="form-control">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select name="area" required data-parsley-required-message = "Area name is required" id="area" class="form-control">
