        ...
        <div class="container-fluid">
            ...
            <div class="row page-titles">
                ...
                <div class="col-md-7 align-self-center text-right">
                    <div class="d-flex justify-content-end align-items-center">
                        ...
                        <a href="{{route('vendor.product.list')}}" class="btn btn-info btn-sm d-none d-lg-block m-l-15"><i class="fa fa-plus-circle"></i> Product List</a>
                    </div>
                </div>
            </div>
            <!-- ============================================================== -->
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form action="{{route('vendor.product.store')}}" data-parsley-validate enctype="multipart/form-data" method="post" id="product">
                        @csrf
                                       ...
                                       <div class="col-md-12 title_head">
                                        ...
                                        <div class="col-md-12">
                                        	<div class="form-group">
	                                           ...
	                                           <textarea style="resize: vertical;" rows="3" name="summery" class="form-control">{{old('summery')}}</textarea>
	                                       </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="form-group">
