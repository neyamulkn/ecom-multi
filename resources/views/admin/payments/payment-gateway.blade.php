                    ...
                    <div class="col-md-7 align-self-center text-right">
                        <div class="d-flex justify-content-end align-items-center">
                            ...
                            <button data-toggle="modal" data-target="#add" class="btn btn-info d-none d-lg-block m-l-15"><i
                                    class="fa fa-plus-circle"></i> Add Manual Payment gateway</button>
                        </div>
                    </div>
                </div>
                <!-- ============================================================== -->
                                            ...
                                            <tr id="item{{$gateway->id}}">
                                                ...
                                                <td>
                                                    <div class="bt-switch">
                                                        ...
                                                        <input type="checkbox"  onchange="paymentModeChange({{$gateway->id}})" {{($gateway->method_mode == 'live') ? 'checked' : ''}}  data-on-color="success" data-off-color="warning" data-on-text="Live" data-off-text="Test"> 
   ...
   <script>
    ...
    <script type="text/javascript">
        ...
        function paymentModeChange(id){
            ...
            var  url = '{{route("paymentModeChange")}}';
