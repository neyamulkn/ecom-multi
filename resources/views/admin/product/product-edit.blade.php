                                            ...
                                            <div class="form-group">
                                                ...
                                                <select onchange="getAttributeByCategory(this.value, 'getAttributesByChildcategory')" name="childcategory"  id="subchildcategory" class="form-control custom-select">
                                                   @foreach($childcategories as $childcategory)
                                                    <option @if($childcategory->id == $product->chlidcategory_id) 'selected' @endif value="{{$childcategory->id}}">{{$childcategory->name}}</option>
                                                    @endforeach
                                                </select>
                                       ...
                                       <div class="col-md-12 title_head">
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-2 nopadding">
                                                        <div class="form-group">
                                                            ...
                                                            @endif
                                                            <select class="form-control" name="attributeValueUpdate[{{$variation->attribute_id}}][]">
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <div class="row">
                                                ...
                                                <input type="hidden" value="{{$feature->name}}" class="form-control" name="features[{{$feature->feature_id}}]"></div>
                                                <div class="col-8 col-sm-4">
                                                    <input @if($feature->is_required) required @endif type="text" name="featureValue[{{$feature->feature_id}}]" value="{{$feature->value}}" class="form-control" placeholder="Input value here">
                                                </div>
                                                @endforeach
                                            </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <div class="checkbox2">
                                                  <input  @if($product->videos) checked @endif name="product_video" type="checkbox" id="product_video" value="1"> 
                                            ...
                                            <div id="video_display"  style="display: {{($product->videos) ? 'block' : 'none'}};">
...
@section('js')
    ...
    function shipping_fields() {
        ...
        divtest.innerHTML = '<div class="col-md-4"><span class="required">Select Region</span><select required name="video_provider[]" id="video_provider" class="form-control custom-select"><option value="youtube">Youtube</option> <option value="vimeo">Vimeo</option></select></div><div class="col-md-2"><span class="required">Shipping Cost</span><input class="form-control" name="shipping_time" value="{{$product->shipping_time}}" id="ship_time" placeholder="Exm: 50" value="" min="1" type="number"></div><div class="col-md-3"><span>Estimated Shipping Time</span><input class="form-control" name="shipping_time" value="{{$product->shipping_time}}" id="ship_time" value="Exm: 3-4 days" type="text"></div><div class="col-1"><button class="btn btn-danger" type="button" onclick="remove_shipping_fields(' + shipping + ');"><i class="fa fa-times"></i></button></div>';
