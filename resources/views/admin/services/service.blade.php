                                    ...
                                    <table id="myTable" class="table table-bordered table-striped">
                                        ...
                                        <tbody id="positionSorting">
                                            ...
                                            <tr id="item{{$service->id}}">
                                                ...
                                                <td>
                                                    @if($service->image)
                                                    <img src="{{asset('upload/images/services/'. $service->image)}}" width="50" height="50">
                                                    @endif
                                                    @if($service->font)
                                                    <i style="font-size: 40px" class="{{$service->font}}"></i>
                                                    @endif
                                                </td>
                                                
                                                
                                                <td>{!!($service->status == 1) ? "<span class='label label-info'>Active</span>" : '<span class="label label-danger">Deactive</span>'!!} 
                                                </td>
                                                <td>
                                                    <button type="button" onclick="edit('{{$service->id}}')"  data-toggle="modal" data-target="#edit" class="btn btn-info btn-sm"><i class="ti-pencil" aria-hidden="true"></i> Edit</button>
                                                    <button data-target="#delete" onclick='deleteConfirmPopup("{{route("service.delete", $service->id)}}")' class="btn btn-danger btn-sm" data-toggle="modal"><i class="ti-trash" aria-hidden="true"></i> Delete</button>
                                                </td>
                                            </tr>
                                            @endforeach
                                        </tbody>
            ...
            <div class="modal-dialog">
                  ...
                  <div class="modal-content">
                    ...
                    <div class="modal-body form-row">
                        <div class="card-body">
                            <form action="{{route('service.store')}}" enctype="multipart/form-data" method="POST" class="floating-labels">
                                {{csrf_field()}}
                                <div class="form-body">
                                    ...
                                    <div class="row justify-content-md-center">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label class="required" for="subtitle">Sub Title</label>
                                                <input name="subtitle" id="subtitle" value="{{old('subtitle')}}" required="" type="text" class="form-control">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group"> 
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input name="font" id="font" value="{{old('font')}}" placeholder="Example: fa fa-icon" type="text" class="form-control">
                                            </div>
                                        </div>
                                    </div>
