					...
					<div class="row page-builder-ltr">
						...
						<div class="col-xs-6 col-md-2" style="padding: 0 5px;">
							<div class="category-list cat-border">
	                            <div class="category-thumb" style="position: relative;width: 190px; height: 100px; ">
	                               
	                                <img src="{{asset('upload/images/category/thumb/'.$category->image)}}" style="width:100%;height:100%">
	                               
	                                <div class="desc-listcategoreis" >
	                                <div class="name_categories">
	                                    <h6>{{$category->name}}</h6>
	                                </div>
	                                <span class="number_product">{{ count($category->products)}} Products</span>
	                                 <a href="{{route('home.category', $category->slug)}}"> Shop Now <i class="fa fa-angle-right"></i></a>
	                            </div>
	                            </div>
